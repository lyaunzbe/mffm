...
var CLIENT_MAIN_WRT_SERVER_MAIN = '../components/core/clientMain.jsx';
var HTML_MAIN_ABSOLUTE =
  path.resolve(__dirname, '..', 'static_files/index.html');
var PUBLIC_ROOT_ABSOLUTE =
  path.resolve(__dirname, '..', 'static_files/');
var TOP_LEVEL_COMPONENT_PATH =
  path.resolve(__dirname, '..', 'components/core/Application.jsx');
var APP_DIRECTORY_ABSOLUTE = path.resolve(__dirname, '..', 'components/core');
